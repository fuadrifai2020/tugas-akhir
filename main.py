...
def config():
    ...
    st.set_page_config(page_title='PELACAK IP APP', page_icon=img, layout="wide", initial_sidebar_state="expanded")
...
def get_geolocation():
    key = "2179d90aa41645ddaf77733e8b18c55c"
